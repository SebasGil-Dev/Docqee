...
export function PatientAppointmentsPage() {
  ...
  return (
    <div className="student-page-compact flex h-full min-h-0 w-full flex-col overflow-hidden">
      <Seo
      ...
      <AdminPanelCard
        className="flex h-full min-h-0 w-full flex-1 rounded-[1.1rem]"
        panelClassName="rounded-[1.1rem] bg-white"
        shellPaddingClassName="p-0"
      >
        {(successMessage || errorMessage) && (
          <div className="grid shrink-0 gap-2 border-b border-slate-200/80 bg-white px-3 py-2 sm:px-4">
            {successMessage && (
              <div
                className="rounded-[0.9rem] border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-700"
                role="status"
              >
            ...
            {errorMessage && (
              <div
                className="rounded-[0.9rem] border border-rose-200 bg-rose-50 px-3 py-2 text-sm font-medium text-rose-700"
                role="alert"
              >
                {errorMessage}
              </div>
        ...
        <div className="shrink-0 border-b border-slate-200/80 bg-white px-3 py-2 sm:px-4">
          <div className="flex min-w-0 flex-col gap-2 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex min-w-0 flex-wrap items-center gap-2">
              <div className="min-w-0">
                <h1 className="truncate font-headline text-[1.05rem] font-extrabold leading-none tracking-tight text-ink sm:text-[1.15rem]">
                  {patientContent.appointmentsPage.title}
                </h1>
                <p className="mt-1 hidden text-[0.72rem] font-medium leading-none text-ink-muted sm:block">
                  {filteredAppointments.length} citas en la vista actual
                </p>
              </div>
                ...
                {[
                  ...
                  <span
                    ...
                    className={classNames(
                      'inline-flex items-center gap-1 rounded-full px-2 py-1 text-[0.68rem] font-bold leading-none ring-1 ring-inset sm:text-[0.72rem]',
                      metric.tone,
                    )}
                  >
            ...
            <div className="flex min-w-0 items-center gap-2 xl:w-[34rem]">
              <label
              ...
              >
                ...
                <input
                  ...
                  placeholder={
                    patientContent.appointmentsPage.searchPlaceholder
                  }
                  type="search"
                  value={searchTerm}
