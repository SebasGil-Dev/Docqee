  ...
  return (
    <div className={classNames('space-y-1.5', containerClassName)}>
      ...
      >
        ...
        {isOpen ? (
          <div
            className="absolute left-0 top-[calc(100%+0.6rem)] z-20 w-full overflow-hidden rounded-[1.4rem] border border-slate-200/80 bg-white/95 p-2 shadow-[0_24px_60px_-28px_rgba(15,23,42,0.45)] backdrop-blur"
            id={`${id}-menu`}
            role="listbox"
          >
