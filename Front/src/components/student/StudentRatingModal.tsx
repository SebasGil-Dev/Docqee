...
export function StudentRatingModal({
  appointmentId,
  isSubmitting,
  patientName,
  onClose,
      ...
      <div className="w-full max-w-sm overflow-hidden rounded-[1.4rem] border border-slate-200/80 bg-white shadow-[0_32px_80px_-24px_rgba(15,23,42,0.38)]">
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
          <div>
            ...
            <p className="mt-0.5 text-sm font-semibold text-ink">{patientName}</p>
          </div>
          <button
            aria-label="Cerrar"
        ...
        <div className="px-5 py-5">
          <p className="mb-3 text-sm font-medium text-ink-muted">
            ¿Cómo calificarías la experiencia con este paciente?
          </p>
          ...
          <div className="mb-5">
            <label className="mb-1.5 block text-xs font-semibold text-ink-muted" htmlFor="student-rating-comment">
              Comentario (opcional)
            </label>
            <textarea
              ...
              placeholder="Cuéntanos tu experiencia con este paciente..."
              rows={3}
              value={comment}
